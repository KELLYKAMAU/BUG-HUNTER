                    ...
                    <div className="card-body">
                        ...
                        <form className="space-y-4">
                            ...
                            <div className="form-control">
                                ...
                                <input id="start-date" type="date" title="Start Date" placeholder="Start date" className="input input-bordered" />
                            </div>
                            <div className="form-control">
                                <label className="label" htmlFor="end-date">
                                    <span className="label-text">End Date</span>
                                </label>
                                <input id="end-date" type="date" title="End Date" placeholder="End date" className="input input-bordered" />
                            </div>
